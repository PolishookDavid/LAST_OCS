function Header=updateHeader(CameraObj)
   RAD = 180./pi;
   DateObs = datestr(CameraObj.CameraDriverHndl.time_start,'yyyy-mm-ddTHHMMSS.FFF');
   DateVec = datevec(CameraObj.CameraDriverHndl.time_start);
   ...
   if (isnan(CameraObj.MountHndl.MountType))
      ...
      RA  = CameraObj.MountHndl.RA;
      Dec = CameraObj.MountHndl.Dec;
      HA  = CameraObj.MountHndl.HA;
      LST = celestial.time.lst(JD,CameraObj.MountHndl.MountCoo.ObsLon./RAD,'a').*360;
      Az = CameraObj.MountHndl.Az;
      Alt = CameraObj.MountHndl.Alt;
      TrackingSpeed = CameraObj.MountHndl.TrackingSpeed;
      isCounterWeightDown = CameraObj.MountHndl.isCounterWeightDown;
   end

   Instrument = sprintf('LAST-0-%s-%s', MountGeoName, CameraObj.CamGeoName); % 'LAST-node-mount-camera'

   Header = {'NAXIS',2,'number of axes';...
              'NAXIS1',size(CameraObj.CameraDriverHndl.lastImage,2),'size of axis 1 (X)';...
              'NAXIS2',size(CameraObj.CameraDriverHndl.lastImage,1),'size of axis 2 (Y)';...
              ...
              'INTOFFS',CameraObj.CameraDriverHndl.offset,'Camera internal offset level';...
              'BINX',CameraObj.binning(1),'Camera binning in X-axis';...
              'BINY',CameraObj.binning(2),'Camera binning in Y-axis';...
%              'FOCUS',CameraObj.FocuserHndl.Pos,'Focus value';...
%              'PRFOCUS',CameraObj.FocuserHndl.LastPos,'Previous Focus value';...
              'ORIGIN','Weizmann Institute of Science','organization responsible for the data';...
              'TELESCOP','LAST','name of telescope';...
              'CAMERA',CameraObj.CamUniqueName,'Camera name';...
              'INSTRUME',Instrument,'LAST-node-mount-telescope-camera';...
