...
classdef unit <obs.LAST_Handle
    ...
    properties (Dependent)
        ...
        % Cameras
        Temp          % Vector of Temp of 4 cameras
        ExpTime = 1   % vector of 4 ExpTime
        ImType  = 'sci';
        Object  = '';
        CamStatus     % cell array of 4 values
        
        % focusers
        Pos           % vector of 4 positions
        FocStaus      % cell array of 4 status
    ...
    properties(Hidden)
        %
        Config      % unit configuration file
        
        HandleMount      % mount handle
        HandleCam        % 4 elements of camera handles
        HandleFoc        % 4 elements of focusers handles
        HandleSens       % sensors handle
...
%         slewRate = 2.5;
    ...
    methods
        ...
        function MountObj=unit(MountType)  
